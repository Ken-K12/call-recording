/**
 * Lambdaにデプロイ済
 * Kinesis Video Stream への保存情報を保存するLambda
 * 
 */

const AWS = require("aws-sdk");
const region = 'ap-northeast-1';
const bucketName = 'logical-voice-mail-stream-information';
...
exports.handler = async (event) => {
    ...
    console.log('#########streamInformation1############');
    console.log(JSON.stringify(streamInformation));
    ...
    streamInformation.streamARN = audio.StreamARN; //ストリームARN
    console.log('#########streamInformation2############');
    console.log(JSON.stringify(streamInformation));
